...
def run_migration(migrator_name):
    """
    Run a 'S3 bucket to native S3' migration.

    MIGRATOR_NAME should match the value of `migrator_name` as defined in your environment's
    invocation of the `S3-s3-migrator` Terraform module. This is used to locate the relevant
    ...
    while True:
        ...
        if execution_status != "SUCCEEDED":
            ...
            if execution_status in ["FAILED", "TIMED_OUT", "ABORTED"]:
                print(f"S3 bucket scan job {execution_status}")
